export default async function handler(req: any, res: any) {
    ...
    try {
        ...
        // Note: Checking Whop V5 API for fees. Usually sub-resource of payment.
        const response = await fetch(`https://api.whop.com/api/v5/payments/${id}/fees`, {
            method: 'GET',
            headers: {
        ...
        const allFees = Array.isArray(data) ? data : (data.data || []);
